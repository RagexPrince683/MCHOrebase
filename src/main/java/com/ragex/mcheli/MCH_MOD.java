package com.ragex.mcheli;

import com.ragex.mcheli.aircraft.*;
import com.ragex.mcheli.block.MCH_DraftingTableBlock;
import com.ragex.mcheli.block.MCH_DraftingTableTileEntity;
import com.ragex.mcheli.chain.MCH_EntityChain;
import com.ragex.mcheli.chain.MCH_ItemChain;
import com.ragex.mcheli.command.MCH_Command;
import com.ragex.mcheli.compat.ModCompatManager;
import com.ragex.mcheli.compat.oneprobe.AircraftInfoProvider;
import com.ragex.mcheli.container.MCH_EntityContainer;
import com.ragex.mcheli.container.MCH_ItemContainer;
import com.ragex.mcheli.flare.MCH_EntityFlare;
import com.ragex.mcheli.gltd.MCH_EntityGLTD;
import com.ragex.mcheli.gltd.MCH_ItemGLTD;
import com.ragex.mcheli.gui.MCH_GuiCommonHandler;
import com.ragex.mcheli.helicopter.MCH_EntityHeli;
import com.ragex.mcheli.helicopter.MCH_HeliInfo;
import com.ragex.mcheli.helicopter.MCH_ItemHeli;
import com.ragex.mcheli.helper.*;
import com.ragex.mcheli.helper.info.ContentRegistries;
import com.ragex.mcheli.item.MCH_Item;
import com.ragex.mcheli.item.MCH_ItemInfo;
import com.ragex.mcheli.item.MCH_ItemInfoManager;
import com.ragex.mcheli.light.BlockLight;
import com.ragex.mcheli.lweapon.MCH_ItemLightWeaponBase;
import com.ragex.mcheli.lweapon.MCH_ItemLightWeaponBullet;
import com.ragex.mcheli.mob.MCH_EntityGunner;
import com.ragex.mcheli.mob.MCH_ItemSpawnGunner;
import com.ragex.mcheli.parachute.MCH_EntityParachute;
import com.ragex.mcheli.parachute.MCH_ItemParachute;
import com.ragex.mcheli.plane.MCP_EntityPlane;
import com.ragex.mcheli.plane.MCP_ItemPlane;
import com.ragex.mcheli.plane.MCP_PlaneInfo;
import com.ragex.mcheli.ship.MCH_EntityShip;
import com.ragex.mcheli.ship.MCH_ItemShip;
import com.ragex.mcheli.ship.MCH_ShipInfo;
import com.ragex.mcheli.tank.MCH_EntityTank;
import com.ragex.mcheli.tank.MCH_ItemTank;
import com.ragex.mcheli.tank.MCH_TankInfo;
import com.ragex.mcheli.throwable.MCH_EntityThrowable;
import com.ragex.mcheli.throwable.MCH_ItemThrowable;
import com.ragex.mcheli.throwable.MCH_ThrowableInfo;
import com.ragex.mcheli.tool.MCH_ItemWrench;
import com.ragex.mcheli.tool.rangefinder.MCH_ItemRangeFinder;
import com.ragex.mcheli.uav.MCH_EntityUavStation;
import com.ragex.mcheli.uav.MCH_ItemUavStation;
import com.ragex.mcheli.vehicle.MCH_EntityVehicle;
import com.ragex.mcheli.vehicle.MCH_ItemVehicle;
import com.ragex.mcheli.vehicle.MCH_VehicleInfo;
import com.ragex.mcheli.weapon.*;
import com.ragex.mcheli.wrapper.W_Item;
import com.ragex.mcheli.wrapper.W_LanguageRegistry;
import com.ragex.mcheli.wrapper.W_NetworkRegistry;
...
public class MCH_MOD {
    ...
    @SidedProxy(
            clientSide = "com.ragex.mcheli.MCH_ClientProxy",
            serverSide = "com.ragex.mcheli.MCH_CommonProxy"
    )
