package com.ragex.mcheli.command;
...
import com.ragex.mcheli.multiplay.MultiplayerHandler;
import com.ragex.mcheli.networking.packet.PacketHandleCommand;
import com.ragex.mcheli.networking.packet.PacketSyncServerSettings;
import com.ragex.mcheli.networking.packet.PacketTitle;
...
public class MCH_Command extends CommandBase {
    ...
    public @NotNull String getUsage(@NotNull ICommandSender sender) {
        return "commands.com.ragex.mcheli.usage";
    }
    ...
    private void handleReconfig(ICommandSender sender, String[] prm) throws CommandException {
        ...
        String msg = MCH_MOD.proxy.isSinglePlayer()
                ? "Reload com.ragex.mcheli.cfg"
                : "Reload server side com.ragex.mcheli.cfg";
    ...
    private void handleTitle(String[] prm) throws CommandException {
        ...
        try {
            ...
            throw new SyntaxErrorException("com.ragex.mcheli.title.jsonException", root == null ? "" : root.getMessage());
        }
    }
