...
import com.ragex.mcheli.MCH_KeyName;
...
public class MCH_GuiGLTD extends MCH_Gui {
    ...
    public void drawKeyBind(MCH_Camera camera, int color, int colorCannotUse) {
        ...
        OffX += 60;
        this.drawString(MCH_KeyName.getDescOrName(42) + " or " + MCH_KeyName.getDescOrName(MCH_Config.KeyUnmount.prmInt), OffX, OffY, color);
