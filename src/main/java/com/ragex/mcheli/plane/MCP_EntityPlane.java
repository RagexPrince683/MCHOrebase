package com.ragex.mcheli.plane;
...
public class MCP_EntityPlane extends MCH_EntityAircraft {
    ...
    public void changeType(String type) {
        ...
        if (this.planeInfo == null) {
            MCH_Lib.Log(this, "##### MCP_EntityPlane changePlaneType() Plane info null %d, %s, %s", getEntityId(this), type, this.getEntityName());
            this.setDead();
        } else {
    ...
    protected void readEntityFromNBT(NBTTagCompound par1NBTTagCompound) {
        ...
        if (this.planeInfo == null) {
            ...
            if (this.planeInfo == null) {
                MCH_Lib.Log(this, "##### MCP_EntityPlane readEntityFromNBT() Plane info null %d, %s", getEntityId(this), this.getEntityName());
                this.setDead();
            } else {
                this.setAcInfo(this.planeInfo);
            }
