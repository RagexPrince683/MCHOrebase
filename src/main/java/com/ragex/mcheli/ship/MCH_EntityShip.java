package com.ragex.mcheli.ship;

import com.ragex.mcheli.MCH_Config;
import com.ragex.mcheli.MCH_Lib;
import com.ragex.mcheli.aircraft.MCH_AircraftInfo;
import com.ragex.mcheli.aircraft.MCH_EntityAircraft;
import com.ragex.mcheli.aircraft.MCH_Parts;
...
public class MCH_EntityShip extends MCH_EntityAircraft {
    ...
    public void changeType(String type) {
        ...
        if (this.planeInfo == null) {
            MCH_Lib.Log(this, "##### MCH_EntityShip changePlaneType() Plane info null %d, %s, %s", W_Entity.getEntityId(this), type, this.getEntityName());
            this.setDead();
        } else {
    ...
    protected void readEntityFromNBT(NBTTagCompound par1NBTTagCompound) {
        ...
        if (this.planeInfo == null) {
            ...
            if (this.planeInfo == null) {
                MCH_Lib.Log(this, "##### MCH_EntityShip readEntityFromNBT() Plane info null %d, %s", W_Entity.getEntityId(this), this.getEntityName());
                this.setDead();
            } else {
                this.setAcInfo(this.planeInfo);
            }
