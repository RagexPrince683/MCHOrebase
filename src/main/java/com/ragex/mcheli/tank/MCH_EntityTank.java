package com.ragex.mcheli.tank;

import com.ragex.mcheli.MCH_Config;
import com.ragex.mcheli.MCH_Lib;
import com.ragex.mcheli.MCH_MOD;
import com.ragex.mcheli.MCH_Math;
import com.ragex.mcheli.aircraft.*;
import com.ragex.mcheli.chain.MCH_EntityChain;
import com.ragex.mcheli.networking.packet.PacketStatusRequest;
import com.ragex.mcheli.particles.MCH_ParticleParam;
import com.ragex.mcheli.particles.MCH_ParticlesUtil;
import com.ragex.mcheli.weapon.MCH_EntityBaseBullet;
import com.ragex.mcheli.weapon.MCH_WeaponSet;
import com.ragex.mcheli.wrapper.W_Block;
import com.ragex.mcheli.wrapper.W_Entity;
import com.ragex.mcheli.wrapper.W_Lib;
import com.ragex.mcheli.wrapper.W_WorldFunc;
...
//                  }
        ...
        if (bb != null) {
            ...
            if (!(speed <= 0.05)) {
                ...
                MCH_EntityAircraft rideAc = this.getRidingEntity() instanceof MCH_EntitySeat
                        ...
                        : (this.getRidingEntity() instanceof MCH_EntityAircraft ? (MCH_EntityAircraft) this.getRidingEntity() : null);
                List<Entity> list = this.world
                        .getEntitiesInAABBexcluding(
                                ...
                                ex -> {
                                    if (ex != rideAc
                                            && !(ex instanceof EntityItem)
                                            && !(ex instanceof EntityXPOrb)
    ...
    private boolean shouldCollisionDamage(Entity e) {
        if (this.getSeatIdByEntity(e) >= 0) {
            ...
            return (!(e.getRidingEntity() instanceof MCH_EntityAircraft) || !this.noCollisionEntities.containsKey(e.getRidingEntity())) && (!(e.getRidingEntity() instanceof MCH_EntitySeat)
