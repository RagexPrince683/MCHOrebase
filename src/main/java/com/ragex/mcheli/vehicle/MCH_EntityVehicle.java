package com.ragex.mcheli.vehicle;
...
import com.ragex.mcheli.weapon.MCH_WeaponParam;
...
public class MCH_EntityVehicle extends MCH_EntityAircraft {
    ...
    public void changeType(String type) {
        ...
        if (this.vehicleInfo == null) {
            MCH_Lib.Log(this, "##### MCH_EntityVehicle changeVehicleType() Vehicle info null %d, %s, %s", getEntityId(this), type, this.getEntityName());
            this.setDead();
        } else {
    ...
    protected void readEntityFromNBT(NBTTagCompound par1NBTTagCompound) {
        ...
        if (this.vehicleInfo == null) {
            ...
            if (this.vehicleInfo == null) {
                MCH_Lib.Log(this, "##### MCH_EntityVehicle readEntityFromNBT() Vehicle info null %d, %s", getEntityId(this), this.getEntityName());
                this.setDead();
            } else {
                this.setAcInfo(this.vehicleInfo);
            }
